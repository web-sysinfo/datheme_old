...
<div class="main-page-wrapper">
		...
		<!-- header-area start -->
		<header class="theme-main-menu theme-menu-seven">
			<div class="main-header-area">
				<div class="container-fluid">
					<div class="row align-items-center justify-content-between">
						<div class="col-md-auto col-6">
							<div class="logo-area">
								<a class="logo" href="index.html"><img src="assets/img/logo/header-logo-4.svg"
										alt="Header-logo"></a>
								<a class="sticky-logo" href="index.html"><img src="assets/img/logo/header-logo-1.svg"
										alt="Header-logo"></a>
							</div>
						</div>
						...
						<div class="col-md-auto col-6">
							<div class="right-nav d-flex align-items-center justify-content-end">
								<div class="quote-btn d-xl-inline-block d-none">
									<a href="contact.html" class="ht-btn bs-btn">Contact us</a>
								</div>
								<div class="search-area ms-md-3 d-none">
								...
								<div class="cart-menu">
									<a class="shopping-cart ms-md-3" href="#">
										<i class="bi bi-bag"></i>
		...
		<main>
						...
						<div class="col-xl-7">
							<div class="img-wrapper-four row align-items-end position-relative mb-xl-0 mb-5">
								<div class="col-md-5 mb-md-0 mb-4">
									<img class="main-img img-fluid" src="assets/img/media/media-18.jpg" alt="portfolio">
								</div>
								<div class="col-md-7">
									<img class="shape-sticker-2" src="assets/img/shape/shape-18.png" alt="portfolio">
									<img class="shape-sticker" src="assets/img/shape/shape-19.png" alt="portfolio">
									<img class="main-img2 img-fluid" src="assets/img/media/media-19.jpg"
										alt="portfolio">
								</div>
							</div>
						</div>
						<div class="col-xl-5">
							<div class="text-wrapper-four ps-xxl-4">
								...
								<div class="bottom-btn pt-xxl-2">
									<a href="about-2.html"
										class="ht-btn w-100 pl-40 pe-4 d-flex justify-content-between">About us
			...
			<section class="bg-service-section-3 pt-130 pb-100 pt-lg-60 pb-lg-20"
				data-background="assets/img/bg/bg-5.png">
				<div class="container">
					<div class="row justify-content-center">
						...
						<div class="col-xl-6 col-lg-6">
							<div class="title-one ps-xxl-4 mb-70">
								...
								<a class="ht-btn style-10 mt-4" href="services.html"><span>All Services</span>
									<span><img src="assets/img/icon/arrow-2.svg" alt="arrow"></span></a>
							</div>
						</div>
					</div>
					<div class="row align-items-center justify-content-center">
						<div class="col-lg-6 col-md-6">
							<div class="service-wrap-3">
								<div class="icon">
									<img class="back-icon" src="assets/img/shape/shape-15.svg" alt="shape">
									<img class="front-icon" src="assets/img/icon/icon-24.svg" alt="icon">
								</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="service-wrap-3">
								<div class="icon">
									<img class="back-icon" src="assets/img/shape/shape-15.svg" alt="shape">
									<img class="front-icon" src="assets/img/icon/icon-25.svg" alt="icon">
								</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="service-wrap-3">
								<div class="icon">
									<img class="back-icon" src="assets/img/shape/shape-15.svg" alt="shape">
									<img class="front-icon" src="assets/img/icon/icon-26.svg" alt="icon">
								</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="service-wrap-3">
								<div class="icon">
									<img class="back-icon" src="assets/img/shape/shape-15.svg" alt="shape">
									<img class="front-icon" src="assets/img/icon/icon-27.svg" alt="icon">
								</div>
					...
					<div class="row align-items-center">
							...
							<div class="feedback-wrapper-content">
								<div class="author-content-slider">
									<div class="feedback-wrap-6">
										<img src="assets/img/icon/icon-28.svg" alt="quote">
								...
								<div class="custom-arrow-one d-none d-xxl-inline-block">
									<div class="prev-p1 ms-3 slick-arrow"><img src="assets/img/icon/arrow-11.svg"
											alt="arrow">
									</div>
									<div class="next-p1 slick-arrow"><img src="assets/img/icon/arrow-12.svg"
											alt="arrow">
									</div>
								</div>
							</div>
						...
						<div class="col-lg-6 col-xl-5 author-thumb-slider">
							<div class="author-avatar-2 text-center position-relative">
								<img class="bg-shape" src="assets/img/shape/shape-26.png" alt="shape">
								<img class="author-main-img" src="assets/img/media/media-16.png" alt="author">
			...
			<section class="bg-blog-section-2 pt-140 pt-lg-60 pb-95 pb-lg-15">
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-6">
							<div class="title-one mb-65 mb-lg-20">
			...
			<!-- ht-cta start -->
			<div class="bg-cta-section-2 pt-80 pb-70" data-background="assets/img/bg/bg-3.jpg">
				<div class="container-fluid">
					<div class="cta-bg-3">
						<div class="row align-items-center justify-content-center">
							...
							<div class="col-lg-4 text-lg-end text-center">
								<div class="video-wrap-3">
									<img class="back-shape" src="assets/img/shape/shape-21.png" alt="sticker">
									<a href="contact.html" class="popup-video"><img src="assets/img/icon/icon-39.svg"
											alt="play"></a>
								</div>
							</div>
						</div>
		...
		<!--footer-area start-->
		<footer class="footer-four pt-130 pt-lg-100">
			<div class="container-fluid">
				<div class="row mb-30">
					<div class="col-xxl-4 col-lg-6 col-md-6">
						<div class="footer-widget mb-30">
							<div class="footer-logo">
								<a href="index.html"><img src="assets/img/logo/header-logo-1.svg" alt="logo"></a>
							</div>
							<p class="mt-30 mb-30">A reputable SEO agency begins with a analysis comprehensive analysis.
							</p>
							<img class="shape-1 d-none d-lg-inline-block" src="assets/img/shape/shape-4.png"
								alt="Shape">
						</div>
					</div>
					...
					<div class="col-xxl-3 col-lg-6 col-md-6 ps-xxl-5">
						<div class="footer-widget mb-30">
							<h4 class="widget-title">Contact Us</h4>
							<ul>
								<li>
									<a href="mailto:seomagency1234@gmail.com">seomagency1234@gmail.com</a>
								</li>
								<li>
					...
					<div class="col-xxl-3 col-lg-6 col-md-6">
						<div class="footer-widget mb-30">
							...
							<p>Stay update with the latest.</p>
			...
			<div class="container-fluid">
				<div class="copyright-wrap pb-xl-0 pb-5">
					<div class="row align-items-center">
						...
						<div
							class="col-xl-4 col-lg-6 d-flex justify-content-xl-center justify-content-lg-end justify-content-center mb-lg-0 mb-4">
